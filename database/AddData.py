...
create_task(2,'Y001','Lab1',5)
create_task(2,'Y002','Lab2',15)

create_score('T001',59340500001,5)
create_score('T001',59340500002,4)
create_score('T001',59340500003,3)
create_score('T001',59340500004,2)
create_score('T001',59340500005,1)
create_score('T001',59340500006,5)
create_score('T001',59340500007,4)
create_score('T001',59340500008,3)
create_score('T001',59340500009,2)
create_score('T001',59340500010,1)
create_score('T001',59340500011,5)
create_score('T001',59340500012,4)
create_score('T001',59340500013,3)
create_score('T001',59340500014,2)
create_score('T001',59340500015,1)
create_score('T001',59340500016,5)
